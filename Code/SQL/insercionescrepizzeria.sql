...
insert into Empleados values (4, 'Miriam Farfán', 'Cocina (Horno)', 0.00, 'miriam123', 1)
insert into Empleados values (5, 'César Alvarado', 'Cocina (Crepas)', 45.00, 'cesar321', 1)
insert into Empleados values (6, 'Eduardo Lúa', 'Mesero(a)', 0.00, 'muguiwaralua', 1)
insert into Empleados values (7, 'Diana Farfán', 'Mesero(a)', 35.00, 'diana123', 1)

select * from Empleados
select nombrempleado from Empleados where nombrempleado='Gerardo Viveros' and contraseña='gerabichochas'
/* ----------------------------------- Cuenta ---------------------------------------------------------- */
...
insert into ComprasEmpleados values (5, 6) /* César, Fresas */
